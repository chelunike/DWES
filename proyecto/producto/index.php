                    ...
                    <table id="tablaProducto" class="table">
                        ...
                        <?php
                            foreach($productos as $producto) {
                                ?>
                                <tr>
                                    <td scope="row"><input type="checkbox" name="ids[]" value="<?= $producto->getId()?>" form="fBorrar"/></td>
                                    <td scope="row"><?php echo $producto->getId(); ?></td>
                                    <td scope="row"><?= $producto->getNombre() ?></td>
                                    <td scope="row"><?= $producto->getPrecio() ?></td>
                                    <td scope="row"><?= $producto->getObservaciones() ?></td>
                                    <td scope="row"><a href="edit.php?id=<?= $producto->getId() ?>" class="editar">Editar</a></td>
                                    <td scope="row"><a href="dodelete.php?id=<?= $producto->getId() ?>" class="borrar">Borrar</a></td>
                                    <!--<td scope="row"><a href="dodelete.php?id=<?= $producto->getId()?>" class="borrar">Borrar</a></td>-->
                                    <!--<td scope="row"><a href="#" data-id="<?= $producto->getId()?>" class="editar2">Editar</a></td>-->
                                </tr>
                                <?php
                            }
                        ?>
