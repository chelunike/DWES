...
class User {
    ...
    /**
     * @Column(type="smallint", length=255, nullable=true)
     */
    private $gender;
     ...
     * Add project
     *
     * @param \izv\data\Project $project
     *
     * @return User
     */
    public function addProject(\izv\data\Project $project)
    {
     ...
     * @param \izv\data\Project $project
     */
    public function removeProject(\izv\data\Project $project)
    {
